export const WORLD_CONFIG = [
  ...
  },
  {
    ...
    range: [1000, 7999],
    types: ['which_place','whats_worth','true_false','missing_digit'],
  ...
  },
  {
    ...
    range: [1000, 9999],
    types: ['which_place','whats_worth','build_it','expanded_form',
